...
#https://www.pichau.com.br/notebooks/notebooks?page=1


#print("Coloque o nome do produto desejado:")
def pichau(produto,number):
    agora = datetime.now()
    ...
    url = f"https://www.pichau.com.br/{produto}/{produto}?page={number}"
    ...
    nomes = soup.find_all(class_=re.compile(r"\bMuiTypography-root\b"))
    
    preco = soup.find_all(class_=re.compile(r"\bmui-1q2ojdg-price_vista\b"))
    produtos = []
...
for i in range(1):
    resultado = pichau(nome_produto, pages)
    pages +=1
    i +=1